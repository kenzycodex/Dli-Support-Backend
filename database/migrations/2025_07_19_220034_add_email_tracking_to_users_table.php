...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('failed_emails', function (Blueprint $table) {
            ...
            $table->json('context')->nullable(); // Additional context like admin_id, bulk_operation_id
        ...
        // Create bulk operation tracking table
        Schema::create('bulk_operations', function (Blueprint $table) {
            ...
            $table->json('results_summary')->nullable(); // Store detailed results
            $table->string('source_file')->nullable(); // CSV filename if applicable
            $table->timestamps();
